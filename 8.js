    ...
    for (let i = 0; i < weeks; i++) {
        ...
        for (let j = 0; j < 7; j++) {
            ...
            if ((y < prev_days + 1) || (y > prev_days + month_length)) {
				...
				if ((birthday[0] == y) && ((birthday[1] - 1) == my_month)) {
					x = 'birthday';
				}
// Здесь добавляем пометку своего дня рождения классом 'birthday'. иксу задаем класс
            }
...
$(function(){
    ...
    $('button.birthday').click(function(){
	   ...
	   birthday = prompt('Введите дату Вашего рождения в формате ДД-ММ-ГГГГ:', '01-01-1900');
